...
<html lang="en-US">
  <head>
    ...
    <link href="{{ asset('Assets-Agung/./css/font-awesome/css/all.min.css?ver=1.2.0') }}" rel="stylesheet">
    <link href="{{ asset('Assets-Agung/./css/bootstrap-icons/bootstrap-icons.css?ver=1.2.0') }}" rel="stylesheet">
    <link href="{{ asset('Assets-Agung/./css/bootstrap.min.css?ver=1.2.0') }}" rel="stylesheet">
    <link href="{{ asset('Assets-Agung/./css/aos.css?ver=1.2.0') }}" rel="stylesheet">
    <link href="{{ asset('Assets-Agung/./css/main.css?ver=1.2.0') }}" rel="stylesheet">
    <noscript>
      <style type="text/css">
        [data-aos] {
            opacity: 1 !important;
  ...
  <body id="top">
    <header class="bg-light">
      <nav class="navbar navbar-expand-lg navbar-light bg-light" id="header-nav" role="navigation">
        <div class="container"><a class="link-dark navbar-brand site-title mb-0" href="#">Agung Raviano</a>
...
<header>
  <div class="cover bg-light">
    <div class="container px-3">
      <div class="row">
        <div class="col-lg-6 p-2"><img class="img-fluid" src="{{ asset('Assets-Agung/images/illustrations/hello3.svg') }}" alt="hello"/></div>
        <div class="col-lg-6">
          <div class="mt-5">
            <p class="lead text-uppercase mb-1">Hello!</p>
            <h1 class="intro-title marker" data-aos="fade-left" data-aos-delay="50">I’m Agung Raviano</h1>
            <p class="lead fw-normal mt-3" data-aos="fade-up" data-aos-delay="100">Web Developer</p>
            <div class="social-nav" data-aos="fade-up" data-aos-delay="200">
              <nav role="navigation">
                <ul class="nav justify-content-left">
                  ...
                  <li class="nav-item"><a class="nav-link" href="https://www.facebook.com/AgungRaviano" title="Facebook"><i class="fab fa-facebook"></i><span class="menu-title sr-only">Facebook</span></a></li>
                  <li class="nav-item"><a class="nav-link" href="https://www.instagram.com/zeazo__" title="Instagram"><i class="fab fa-instagram"></i><span class="menu-title sr-only">Instagram</span></a></li>
                </ul>
              </nav>
            </div>
...
<div class="section pt-4 px-3 px-lg-4" id="about">
  <div class="container-narrow">
    <div class="row">
      <div class="col-md-6">
        <h2 class="h4 my-2">Hello! Im Agung Raviano.</h2>
        <p>My name is Agung Raviano Born in Jakarta On October 10, 2006 and I can create a web design using Figma and I can make Web/ Web Develope
          .</p>
        <div class="row mt-3">
          <div class="col-sm-2">
          ...
          <div class="col-sm-10">
            <div class="pb-1 fw-bolder">AgungRavi2@gmail.com</div>
          </div>
          ...
          <div class="col-sm-10">
            <div class="pb-1 fw-bolder">+62 819-3206-0405</div>
          </div>
          <div class="col-sm-2">
            <div class="pb-1">Address:</div>
          </div>
          <div class="col-sm-10">
            <div class="pb-1 fw-bolder">Depok, Indonesia</div>
          </div>
          <div class="col-sm-2">
      ...
      <div class="col-md-5 offset-md-1" data-aos="fade-left" data-aos-delay="100"><img class="avatar img-fluid mt-2" src="{{ asset('Assets-Agung/images/akuganteng.jpg') }}" width="400" height="400" alt="Walter Patterson"/></div>
    </div>
  </div>
</div>
<div class="section px-3 px-lg-4 pt-5" id="services">
  <div class="container-narrow">
    ...
    <div class="text-center">
      <p class="mx-auto mb-3" style="max-width:600px"> Name of school from elementary to high school</p>
    </div>
    <div class="row py-3">
      <div class="col-md-3 text-center" data-aos="fade-up" data-aos-delay="100">
        <div class="h5">SDN Mekarjaya 31 <small>2012-2017</small></div>
      </div>
      <div class="col-md-3 text-center" data-aos="fade-up" data-aos-delay="200">
        <div class="h5">SMP Taruna Bhakti <small>2017-2020</small></div>
      </div>
      <div class="col-md-3 text-center" data-aos="fade-up" data-aos-delay="300">
        <div class="h5">SMK Taruna Bhakti <small>2020-Now</small></div>
      </div>
      </div>
    </div>
  </div>
      ...
      <div class="col-md-6">
        <div class="card mb-3" data-aos="fade-left" data-aos-delay="300">
          <div class="card-header px-3 py-2">
            <div class="d-flex justify-content-between">
              <div>
                <h3 class="h5 mb-1">Front End Developer</h3>
              </div>
            </div>
          </div>
          <div class="card-body px-3 py-2">
            <p>here I create a web design that looks attractive using HTML CSS and JavaScript
            </p>
          </div>
        </div>
      </div>
      <div class="col-md-6">
        <div class="card mb-3" data-aos="fade-right" data-aos-delay="200">
          <div class="card-header px-3 py-2">
            <div class="d-flex justify-content-between">
              <div>
                <h3 class="h5 mb-1">Canteen Keeper</h3>
              </div>
            </div>
          </div>
          <div class="card-body px-3 py-2">
            <p>Ever looked after the canteen and cooked for a school project to get work experience</p>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="bg-light p-3">
      <div class="row">
        <div class="col-md-5">
          ...
          <div class="py-1">
            <div class="d-flex text-small fw-bolder"><span class="me-auto">Photoshop</span><span>75%</span></div>
            <div class="progress my-1">
      ...
      <div class="col-md-6" data-aos="fade-left" data-aos-delay="300">
        ...
        <div class="mt-53 px-1">
          <div class="row"> 
            ...
            <div class="col-sm-10">
              <div class="pb-1 fw-bolder">AgungRaviano@gmail.com</div>
            </div>
            <div class="col-sm-2">
              <div class="pb-1">Phone:</div>
            </div>
            <div class="col-sm-10">
              <div class="pb-1 fw-bolder">+6281932060405</div>
            </div>
          </div>
        </div>
      </div>
...
<footer class="pt-4 pb-4 text-center bg-light">
  <div class="container">
    ...
    <script src="{{ asset('Assets-Agung/./scripts/imagesloaded.pkgd.min.js?ver=1.2.0') }}"></script>
    <script src="{{ asset('Assets-Agung/./scripts/masonry.pkgd.min.js?ver=1.2.0') }}"></script>
    <script src="{{ asset('Assets-Agung/./scripts/BigPicture.min.js?ver=1.2.0') }}"></script>
    <script src="{{ asset('Assets-Agung/./scripts/purecounter.min.js?ver=1.2.0') }}"></script>
    <script src="{{ asset('Assets-Agung/./scripts/bootstrap.bundle.min.js?ver=1.2.0') }}"></script>
    <script src="{{ asset('Assets-Agung/./scripts/aos.min.js?ver=1.2.0') }}"></script>
    <script src="{{ asset('Assets-Agung/./scripts/main.js?ver=1.2.0') }}"></script>
  </body>
</html>