...
<head>
  ...
  <link href="{{ asset('Assets-siti/css/font-awesome/css/all.min.css?ver=1.2.0') }}" rel="stylesheet">
  <link href="{{ asset('Assets-siti/css/bootstrap.min.css?ver=1.2.0') }}" rel="stylesheet">
  <link href="{{ asset('Assets-siti/css/aos.css?ver=1.2.0') }}" rel="stylesheet">
  <link href="{{ asset('Assets-siti/css/main.css?ver=1.2.0') }}" rel="stylesheet">
  <noscript>
    <style type="text/css">
      [data-aos] {
        opacity: 1 !important;
...
<body id="top">
  <header class="d-print-none">
    <div class="container text-center text-lg-left">
      <div class="py-3 clearfix">
        <h1 class="site-title mb-0">Siti Nurul Homisah</h1>
        <div class="site-nav">
          <nav role="navigation">
            <ul class="nav justify-content-center">
              <li class="nav-item"><a class="nav-link" href="https://www.instagram.com/sitinurulhomisah/"
                  title="Instagram"><i class="fab fa-instagram"></i><span
                    class="menu-title sr-only">Instagram</span></a>
              </li>
              <li class="nav-item"><a class="nav-link" href="https://twitter.com/panggilakusuep" title="Twitter"><i
                    class="fab fa-twitter"></i><span class="menu-title sr-only">Twitter</span></a>
              </li>
              <li class="nav-item"><a class="nav-link" href="https://github.com/sitinurulhomisah" title="Github"><i
  ...
  <div class="page-content">
    <div class="container">
      <div class="cover shadow-lg bg-white">
          ...
          <div class="row">
            <div class="col-lg-4 col-md-5">
              <div class="avatar hover-effect bg-white shadow-sm p-1">
                <img src="{{ asset('Assets-siti/images/a.jpg') }}" height="200" />
              </div>
            </div>
            <div class="col-lg-8 col-md-7 text-center text-md-start">
              <h2 class="h1 mt-2" data-aos="fade-left" data-aos-delay="0">Siti Nurul Homisah</h2>
              <p data-aos="fade-left" data-aos-delay="100">Web Designer & Web Developer</p>
              <div class="d-print-none" data-aos="fade-left" data-aos-delay="200">
                ...
                <a class="btn btn-success shadow-sm mt-1" href="#contact">Contact Me</a>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="about-section pt-4 px-3 px-lg-4 mt-1">
          <div class="row">
            <div class="col-md-6">
              ...
              <p>Hello! I’m Siti Nurul Homisah. I am passionate about UI/UX design and Web Design. I am a skilled Front-end
            ...
            <div class="col-md-5 offset-md-1">
              <div class="row mt-2">
                ...
                <div class="col-sm-8">
                  <div class="pb-1 text-secondary">16</div>
                </div>
                <div class="col-sm-4">
                  <div class="pb-1">Email</div>
                </div>
                <div class="col-sm-8">
                  <div class="pb-1 text-secondary">sitinurulhomisah@gmail.com</div>
                </div>
                <div class="col-sm-4">
                  <div class="pb-1">Phone</div>
                </div>
                <div class="col-sm-8">
                  <div class="pb-1 text-secondary">+62 838-7413-5397</div>
                </div>
                <div class="col-sm-4">
                  <div class="pb-1">Address</div>
                </div>
                <div class="col-sm-8">
                  <div class="pb-1 text-secondary">A13, Depok, West Java, I.N.A</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="row">
              ...
              <div class="mb-2"><span>HTML</span>
                <div class="progress my-1">
                  <div class="progress-bar bg-primary" role="progressbar" data-aos="zoom-in-right" data-aos-delay="100"
                    data-aos-anchor=".skills-section" style="width: 97%" aria-valuenow="90" aria-valuemin="0"
              ...
              <div class="mb-2"><span>CSS</span>
                <div class="progress my-1">
                  <div class="progress-bar bg-primary" role="progressbar" data-aos="zoom-in-right" data-aos-delay="200"
                    data-aos-anchor=".skills-section" style="width: 90%" aria-valuenow="85" aria-valuemin="0"
                    aria-valuemax="100"></div>
                </div>
              </div>
              <div class="mb-2"><span>JavaScript</span>
                <div class="progress my-1">
                  <div class="progress-bar bg-primary" role="progressbar" data-aos="zoom-in-right" data-aos-delay="300"
                    data-aos-anchor=".skills-section" style="width: 85%" aria-valuenow="75" aria-valuemin="0"
                    aria-valuemax="100"></div>
                </div>
              </div>
            </div>
            <div class="col-md-6">
              ...
              <div class="mb-2"><span>Sketch</span>
                <div class="progress my-1">
                  <div class="progress-bar bg-success" role="progressbar" data-aos="zoom-in-right" data-aos-delay="500"
              ...
              <div class="mb-2"><span>Adobe XD</span>
                <div class="progress my-1">
                  <div class="progress-bar bg-success" role="progressbar" data-aos="zoom-in-right" data-aos-delay="600"
        ...
        <div class="education-section px-3 px-lg-4">
          ...
          <div class="timeline">
            ...
            <div class="timeline-card timeline-card-success card shadow-sm">
              <div class="card-body">
                <div class="h5 mb-1">Al-Hijrah <span class="text-muted h6">Kindergarden</span></div>
                <div class="text-muted text-small mb-2">2011 - 2012</div>
            ...
            <div class="timeline-card timeline-card-success card shadow-sm">
              <div class="card-body">
                <div class="h5 mb-1">SDN Sukatani 6 <span class="text-muted h6">Elementary school </span></div>
                <div class="text-muted text-small mb-2">2012 - 2018</div>
            ...
            <div class="timeline-card timeline-card-success card shadow-sm">
              <div class="card-body">
                <div class="h5 mb-1">SMPN 11 Depok <span class="text-muted h6">Junior High School</span>
                </div>
            ...
            <div class="timeline-card timeline-card-success card shadow-sm">
              <div class="card-body">
                <div class="h5 mb-1">SMK Taruna Bhakti Depok <span class="text-muted h6">Vocational School</span>
                </div>
                <div class="text-muted text-small mb-2">2021 - 2024</div>
                <!-- <div>User generated content in real-time will have multiple touchpoints for offshoring. Organically grow
                  the holistic world view of disruptive innovation via workplace diversity and empowerment.
                </div> -->
              </div>
        ...
        <hr class="d-print-none" />
        <div class="page-break"></div>
        <div class="section px-2 px-lg-4 pb-4 mb-5" id="contact">
            ...
            <div class="row">
              ...
              <div class="col-md-6" data-aos="fade-left" data-aos-delay="300">
                <div class="mt-3 px-1">
                  ...
                  <p>Or get in touch using my email, instagram or my contact number.</p>
                  <p>See you!</p>
                </div>
                <div class="mt-53 px-1">
                  <div class="row">
                    ...
                    <div class="col-sm-10">
                      <div class="pb-1 fw-bolder">sitinurulhomisah@gmail.com</div>
                    </div>
                    <div class="col-sm-2">
                      <div class="pb-1">Instagram:</div>
                    </div>
                    <div class="col-sm-10">
                      <div class="pb-1 fw-bolder">@sitinurulhomisah</div>
                    </div>
                    <div class="col-sm-2">
                      <div class="pb-1">Phone:</div>
                    </div>
                    <div class="col-sm-10">
                      <div class="pb-1 fw-bolder">+62 838-7413-5397</div>
                    </div>
                  </div>
                </div>
              </div>
  ...
  <footer class=" pb-4 text-muted text-center d-print-none">
    <div class="container">
      <div class="my-3">
        <div class="h4">Siti Nurul Homisah</div>
      ...
      <div class="text-small">
        ...
        <div>Design - <a href="https://www.instagram.com/sitinurulhomisah/" target="_blank">sitinurulhomisah</a></div>
      </div>
    </div>
  </footer>
  <script src="{{ asset('Assets-siti/scripts/bootstrap.bundle.min.js?ver=1.2.0') }}"></script>
  <script src="{{ asset('Assets-siti/scripts/aos.js?ver=1.2.0') }}"></script>
  <script src="{{ asset('Assets-siti/scripts/main.js?ver=1.2.0') }}"></script>
</body>
